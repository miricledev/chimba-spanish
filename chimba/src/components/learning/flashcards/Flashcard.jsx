...
const Flashcard = ({ term, definition, flashcardShown }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div
        className="w-[300px] h-[200px] md:w-[500px] md:h-[300px] perspective cursor-pointer"
        onClick={flipSide}
      >
        <div className={`relative w-full h-full duration-500 transform-style-preserve-3d ${side ? '' : 'rotate-y-180'}`}>
          {/* Front */}
          <div className="absolute w-full h-full backface-hidden bg-[#ff004c] text-white rounded-2xl border border-black flex items-center justify-center text-4xl font-bold shadow-md">
          ...
          {/* Back */}
          <div className="absolute w-full h-full backface-hidden bg-[#ff004c] text-white rounded-2xl border border-black flex items-center justify-center text-4xl font-bold shadow-md rotate-y-180">
      ...
      <button
        onClick={flipSide}
        className="border btn-hover px-4 py-1 rounded-lg font-semibold hover:bg-gray-100 transition"
      >
